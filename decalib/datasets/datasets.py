...
class CameraData(Dataset):
    ...
    def processCameraData(self):
        ...
        print(f"acquisition_time [{prepareimage_time_percentage:.1f}%] {prepareimage_time:.3f}")
        print(f"preparedata_time [{facedetector_time_percentage:.1f}%] {facedetector_time:.3f}")
        print(f"encoding_time [{bbox2point_time_percentage:.1f}%] {bbox2point_time:.3f}")
        print(f"decoding_time [{estimatetransform_time_percentage:.1f}%] {estimatetransform_time:.3f}")
        print(f"landmarks_time [{warp_time_percentage:.1f}%] {warp_time:.3f}")
        print(f"solvepnp_time [{tensors_time_percentage:.1f}%] {tensors_time:.3f}")   
        print(f"++++++++++++")
