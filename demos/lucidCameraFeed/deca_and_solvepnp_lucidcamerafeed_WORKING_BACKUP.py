...
def main(args):
    ...
    global input_image, original_input_image
    global transform_matrix, distance
    ...
    while True:
        ...
        if source["type"] == "camera":
            ...
            if images_from_folder.__len__() > 0:
                ...
                return
        original_input_image = np.copy(input_image)
...
def save_video():
    ...
    image_counter += 1
    original_frames_path = os.path.join(output_folder, "original_frames", f"original_frame_{image_counter}.png")
...
def start_lucid_camera():
    global lucidCamera, num_channels
